...
final class ProductControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'product[is_available]' => 'Testing',
            'product[is_prescription_required]' => 'Testing',
            'product[brand]' => 'Testing',
            'product[expire_at]' => 'Testing',
            'product[category_id]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'product[is_available]' => 'Something New',
            'product[is_prescription_required]' => 'Something New',
            'product[brand]' => 'Something New',
            'product[expire_at]' => 'Something New',
            'product[category_id]' => 'Something New',
        ]);
