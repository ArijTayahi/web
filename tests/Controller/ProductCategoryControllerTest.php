...
final class ProductCategoryControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->productCategoryRepository = $this->manager->getRepository(ProductCategory::class);

        foreach ($this->productCategoryRepository->findAll() as $object) {
    ...
    public function testNew(): void
    {
        ...
        self::assertSame(1, $this->productCategoryRepository->count([]));
    }
    ...
    public function testEdit(): void
    {
        ...
        $fixture = $this->productCategoryRepository->findAll();
    ...
    public function testRemove(): void
    {
        ...
        self::assertResponseRedirects('/product/category/');
        self::assertSame(0, $this->productCategoryRepository->count([]));
    }
}
